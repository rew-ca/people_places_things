...
describe StreetAddress do
  ...
  it "should parse suites in front with dash" do
    addr = StreetAddress.new "12-123 W 15th St"
    addr.number.should == '123'
    addr.name.should == '15th'
    addr.pre_direction == :west
    addr.suffix.should == :street
    addr.unit_type.should == :suite
    addr.unit.should == '12'
  end

  it "should parse suites in front with dash with spaces" do
    addr = StreetAddress.new "12 - 123 15th St W"
    addr.number.should == '123'
    addr.name.should == '15th'
    addr.suffix.should == :street
    addr.post_direction == :west
    addr.unit_type.should == :suite
    addr.unit.should == '12'
  end
  "123- something"
